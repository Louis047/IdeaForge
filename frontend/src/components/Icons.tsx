...
export function IconResearch({ size = 24, className }: IconProps) {
  return (
...
export function IconHeartPulse({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M20.42 4.58a5.4 5.4 0 0 0-7.65 0L12 5.34l-.77-.76a5.4 5.4 0 0 0-7.65 7.65L12 20.65l8.42-8.42a5.4 5.4 0 0 0 0-7.65z" />
...
export function IconSprout({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 22V10" />
      <path d="M5 10c0-5 7-5 7-5s7 0 7 5c0 3-3 5-7 5s-7-2-7-5z" />
      <path d="M12 10c-3-3-7-1-7-1" />
      <path d="M12 10c3-3 7-1 7-1" />
    </svg>
  );
}
